  ...
  <div class="footer__Inner">
    <div class="footer__logoArea">
      <p class="footer__logo">
        <a class="logo" href="/">
          <img src="images/logo.svg" alt="青牡丹工務店">
        </a>
      </p>
      <dl class="footer__companyInfos">
        <div class="footer__companyInfoItem address">
          <dt class="footer__companyInfoTitle">住所</dt>
          <dd class="footer__companyInfoContent">
            <span class="postalCode">〒000-0000</span>
            <span class="address">大阪府大阪市中央区北区南町5-6-7</span>
          </dd>
        </div>
        <div class="footer__companyInfoItem">
          <dt class="footer__companyInfoTitle">営業時間</dt>
          <dd class="footer__companyInfoContent">10:00~20:00</dd>
        </div>
        <div class="footer__companyInfoItem holidays">
          <dt class="footer__companyInfoTitle">定休日</dt>
          <dd class="footer__companyInfoContent">日曜日、祝日、年末年始（12月31日から1月3日まで）</dd>
        </div>
      </dl>
    </div>
    <div class="footer__navListWrap">
      <ul class="footer__navList">
        <li class="footer__navListItem">
          <a href="/" class="footer__navListItemLink">トップページ</a>
        </li>
        <li class="footer__navListItem">
          <a href="about.php" class="footer__navListItemLink">私たちについて</a>
        </li>
        <li class="footer__navListItem">
          <a href="about.php#sectionPhilosophy" class="footer__navListItemLink">経営理念</a>
        </li>
      </ul>
      <ul class="footer__navList">
        <li class="footer__navListItem">
          <a href="about.php#sectionOverview" class="footer__navListItemLink">会社概要</a>
        </li>
        <li class="footer__navListItem">
          <a href="about.php#sectionSafety" class="footer__navListItemLink">安全への取り組み</a>
        </li>
        <li class="footer__navListItem">
          <a href="service.php" class="footer__navListItemLink">事業内容</a>
        </li>
        <li class="footer__navListItem">
          <a href="service.php#sectionHouseBuilding" class="footer__navListItemLink">住宅建築・リフォーム</a>
        </li>
      </ul>
      <ul class="footer__navList">
        <li class="footer__navListItem">
          <a href="service.php#sectionCompanyBuilding" class="footer__navListItemLink">法人新築</a>
        </li>
        <li class="footer__navListItem">
          <a href="service.php#sectionPublicConstruction" class="footer__navListItemLink">公共工事</a>
        </li>
        <li class="footer__navListItem">
          <a href="/#frontNews" class="footer__navListItemLink">
            お知らせ
          </a>
        </li>
        <li class="footer__navListItem">
          <a href="contact.php" class="footer__navListItemLink footer__navListItemLink--hasIcon">
            <svg class="footer__navIcon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <small class="footer__copyright copyright">© AOBOTAN INC.</small>
  </div>
</footer>