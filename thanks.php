<?php
  $title="送信完了｜青牡丹工務店 | 大阪市北区の住宅建築・リフォーム・公共事業なら青牡丹工務店";
  $description="大阪府大阪市に拠点をおく青牡丹工務店です。";
      ...
      <section class="sectionThanks">
        <div class="sectionInner">
          <div class="subPageLead">
            <h1 class="subPageLead__title">送信完了</h1>
          ...
          <div class="beforeFormArea">
            <div class="beforeFormArea__stateboxes">
              <div class="beforeFormArea__statebox">入力</div>
              <div class="beforeFormArea__statebox active">送信完了</div>
            </div>
          ...
          <div class="sectionThanks__backButton">
            <a class="btn btn--bgMainColor" href="/">トップページに戻る</a>
          </div>
        </div>
      </section> 
